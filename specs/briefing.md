...
The [propeller-engine](https://github.com/thomasvolk/propeller-engine/blob/main/docs/json-socket-interface.md) now supports pitch bends. We want to extend the py-propeller DSL to support this feature as well.

## pitch bends in the py-propeller DSL
...
The `PB` element has to be transformed to the [propeller-engine JSON format](https://github.com/thomasvolk/propeller-engine/blob/main/docs/json-socket-interface.md) and transferred via socked to the propeller-engine.
Similar to notes, the propeller-engine provides the `pitch-bends` attribute in the track object.
Here an example how the output look like:
