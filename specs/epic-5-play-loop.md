...
**Confidence Level:** 95% — All open questions resolved. Requirements are specific and testable, shutdown error-suppression behaviour is fully specified, no ambiguities remain.
